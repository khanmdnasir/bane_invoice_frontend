  ...
  return (
    <div ref={drodownButtonRef}>
      ...
      {openBtn && (
        ...
        <div>
        <ul className="overflow-y-auto w-80 md:w-auto absolute left-0 top-0 bg-gray-100 md:bg-white h-screen z-10 md:relative md:text-sm md:h-fit">
